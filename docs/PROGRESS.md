...
| 3 | **Đề xuất & nội dung** | Proposals, Budget, Contents, TeamMembers, Documents, Export, ChangeRequests, AI-summary | 92% | upload siết theo cấu hình Admin: mặc định ≤10MB + whitelist đuôi file (18/07, chuyển sang `system_settings` 20/07). **12/08 — trần kinh phí QĐ543 Điều 14** (cơ bản ≤100tr · ứng dụng ≤150tr): chặn ở cả 4 đường ghi + cửa nộp (`BudgetPolicyService`), trần để ở master data vì Điều 14.3 cho phép Hiệu trưởng duyệt vượt; wizard bỏ ô "Phương thức cấp kinh phí" (không có trong QĐ543), thay bằng **Tổng dự toán** hiện trần tại chỗ; `GET /proposals/{id}/budget/cap`. **Còn thiếu: Điều 15** — trần % theo hạng mục (thù lao 100% · thiết bị 60% · thuê ngoài 60% · hội thảo 30% · VPP 20% · phát sinh 10%), cần chốt cách ánh xạ 12 hạng mục hiện có về 6 nhóm |
