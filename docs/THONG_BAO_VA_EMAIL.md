...
| `MINUTES_REVISION_REQUESTED` | Chủ tịch **trả biên bản cho Thư ký sửa** | Thư ký hội đồng | ✅ | ✅ | HIGH |

**19 loại**, chia hai nhóm:

- **Theo sự kiện** (15 loại) — bắn ngay lúc ai đó bấm nút.
