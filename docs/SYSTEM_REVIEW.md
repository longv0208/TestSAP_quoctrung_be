...
3. **🟠 Báo cáo tiến độ ↔ giải ngân (P6→P1)** — đánh giá "Đạt" chưa set `ConditionMetAt` để mở đợt giải ngân sau (QĐ543 Điều 10.3). Giờ đã có kỳ cố định → **khả thi**, nhưng **cần thầy/leader chốt mapping đợt↔kỳ**.
